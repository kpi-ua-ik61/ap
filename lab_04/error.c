...
/*   Updated: 2016/12/05 13:37:17 by dmaznytskyi                              */
/*                                                                            */
/* ************************************************************************** */
...
void	error(int code)
{
	switch (code)
	{
		...
		case 5:
			...
			break ;
		case 10:
			printf("\n\e[31m\e[1m>>> ПОМИЛКА <<<\e[0m Крок не може дорівнювати нулю!\n");
			break ;
		case 11:
			printf("\n\e[31m\e[1m>>> ПОМИЛКА <<<\e[0m Потрібно вводити х1 і х2 у порядку зростання!");
			break ;
		case 20:
			printf("\n\e[31m\e[1m>>> ПОМИЛКА <<<\e[0m Ви не обрали вірний метод вводу!");
			break ;
		case 21:
			printf("\n\e[31m\e[1m>>> ПОМИЛКА <<<\e[0m Ви не обрали вірний метод сортування!");
			break ;
	}
}
